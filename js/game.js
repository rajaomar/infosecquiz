...
let questions = [
  {
    ...
    pic1: "",
    pic2: "",
    alertmsg: "Incorrect! plugging USB stick essentialy can make them “autorun” - small file is all you need to get virus/worm/trojan/other, if your antivirus isn’t effective. You are at risk of getting your whole computer infected by a malware.",
  },
  {
    question:
    ...
    pic2: "",
    alertmsg: "Incorrect! The website is using a technique called 'Pop-up phishing'. You are being tricked into installing malware/virus on your computer. If you look closely, the url of the ad is not the official url for McAfee.",
  },
  {
    question:
  ...
  },
  {
    ...
    choice4: "",
    answer: 2,
    alertmsg: "Incorrect! You're a tourist and you should never type any sensitive credentials at a place you're not sure of. The computer that you use at the internet cafe could be infected with a keylogger. A keylogger is a software that records every keystroke on the victim's device and sends it to the attacker. The attacker can easily get access to all your social media accounts in this way. It is best to not type any sensitive information that could harm you, if compromised. ",
  },
  {
    question:
  ...
  },
  {
    ...
    alertmsg: "Incorrect! Even though both webpages have the same visual, the URL is different. This is a form of phishing. By trusting the fake webpage, you will enter your credentials and they will be sent to the hacker.",
  },
  {
    question:
    ...
    answer: 1,
    alertmsg: "Incorrect! Not everything and everyone is fake! The website is asking for the correct permissions and so you can grant these permissions.",
  },
  {
    question:
  ...
  },
  {
    ...
    pic2: "",
    alertmsg: "Incorrect! This email is not from Netflix's official email address. If you look closely, you'll notice that the email address belongs to someone else. This is a phishing attempt and should therefore not be trusted.",
  },
  {
    question:
      "You are signing in to a website using your Google account. The website is supposed to get access to read your emails only. You are prompted to the following menu. Do you click 'Allow' and continue?",
    ...
    pic2: "",
    alertmsg: "Incorrect! The website is requesting permission to 'Send emails and change settings' whereas the website is only supposed to get access to view your emails. This is something that can be easily ignored and makes this a good oppurtunity for people to get unwanted access to your account.",
  },
  {
    question:
    ...
    choice2:
      "Forward it to my co-worker to read it.",
    choice3:
  ...
  },
  {
    ...
    pic1: "",
    pic2: "",
    alertmsg: "Incorrect! Once you open the link, your device might get instantly infected. Even though you may think you can exit the site upon verifying that it is a scam website, you already be in danger. It is best to not open the link at all.",
  },
];
